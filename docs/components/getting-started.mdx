...
HTML element that we use to make cards with. application and demonstrate using the React card component.
  ...
  <div class="flex items-center">
    <div>
      <div class="flex items-center">
        ...
        <h3 id="title">
          <a href="#" class="ml-16 hover:no-underline">Min konto</a>
        </h3>
      </div>
      <p class="pt-8 mr-8 hidden md:block">Se dine opplysninger på FINN og Schibstedkonto</p>
    </div>
