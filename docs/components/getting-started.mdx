...
We will afterwards wrap this content in a card component, but lets look at the content first. The svg tag is just a placeholder offcourse, for actual implementation details of svgs with fabric, look at stage 8 in this guide. 
...
#### Lets implement the custom element version of the card component.
