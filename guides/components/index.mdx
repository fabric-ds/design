<div className="grid lg:grid-cols-3 gap-16">
  <div className="lg:col-span-2">
    ...
    <p>
      ...
      written by FINN.no designers and developers. Our blog is the place where
      we show what's powering our service along with useful insights into how to
    ...
    <p>
      ...
      to get a glimpse of what it’s like to work as a designer in FINN, and how
      much we value a culture of fun, engagement, and professional development.
    </p>
    <div className="flex shadow" style={{borderRadius: 5}}>
      <div className="bg-aqua-400 flex items-center px-12" style={{borderTopLeftRadius: 5, borderBottomLeftRadius: 5}}>
        <svg
          width="92"
          height="32"
          viewBox="0 0 92 32"
      ...
      <div className="pl-20">
        ...
        <p className="pb-12 pr-4">
          ...
          and come join our friendly team of skilled designers and developers.
        </p>
      </div>
    </div>
