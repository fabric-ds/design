          ...
          >
            <div className="md:grid md:grid-cols-3">
              <div className="md:col-span-2">
                ...
                >
                  Fabric provides components and tools to our product teams, to
                  help them work more efficiently in creating simple, intuitive,
                  and beautiful experiences for FINN users.
                </p>
              </div>
              <div className="relative -mb-12 hidden lg:block">
                ...
                >
                  <g clip-path="url(#a)">
                    <path
                      d="m301.4 193.6-16.8-18V83.8h16.8v109.9Z"
                      fill="#38BDF8"
                    />
                    <path
                      opacity=".5"
                    ...
                    />
                    <path
                      d="m186.8 193.6 16.7-18V83.8h-16.7v109.9ZM284.6 83.7h-81v92h81v-92Z"
                      fill="#38BDF8"
                    />
                    ...
                    <path
                      d="M296.2 88.7v100H192v-100h104.2Zm5.2-5H186.8v109.9h114.5V83.7Z"
                      fill="#38BDF8"
                    />
                    <path
                      d="M304 198.6H184.1V78.5H304v120Zm-112-7.9H296V86.4H192v104.3Z"
                      fill="#fff"
                    />
                    <path
                    ...
                    <path
                      d="M119.8 7.5h48.1v48.2h-48.1V7.5Zm-7.9-7.9v64h63.8v-64H112Z"
                      fill="#fff"
                    />
                  </g>
                  <defs>
