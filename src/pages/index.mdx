<div className="grid lg:grid-cols-3 gap-16">
  ...
  <div>
    <div className="bg-yellow-100 rounded-8 p-24 mb-24">
      ...
      <p className="pb-0">
        Fabric is currently in Beta phase. We’re working hard to get things
        running smoothly and can’t do it without your help. Head to the{' '}
        <a href="https://sch-chat.slack.com/archives/C01GYKPJVFT">
          #finn-fabric
        </a>{' '}
        channel on Slack to share your feedback.
      </p>
    </div>
