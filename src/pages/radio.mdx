...
<Guideline title="Keyboard focus" image="radio-button-behaviors-keyboard-focus.svg">
...
<Guideline title="Text overflow" image="radio-button-behaviors-text-overflow.svg">
...
<Guideline title="Mixed value" image="radio-button-behaviors-mixed-value.svg">
  When a radio button group presents multiple values that are not identical, the group should not show a selection. Any subsequent selection should update all values.</Guideline>
  
## Usage guidelines

<Guideline title="Use radio buttons for mutually exclusive options" image="radio-button-usage-guidelines-1-Do.svg" good>
...
<Guideline image="radio-button-usage-guidelines-1-Dont.svg" bad>
  
<Guideline title="Label groups of radio buttons" image="radio-button-usage-guidelines-2-Do.svg" good>
...
<Guideline image="radio-button-usage-guidelines-2-Dont.svg" bad>
